...
%><%@taglib prefix="nb-academy" uri="http://www.nb.com/taglibs/nb-academy/1.0" %><%
%><cq:defineObjects />

<%
    // Explanation: We set these variables to be used across the project
...
if (slingSettings.getRunModes().contains("publish")) {
    request.setAttribute("aemDomain", "dispatcher");
} else {
    request.setAttribute("aemDomain", "author");
}
